...
##Reasons why a mass would get dropped from this mass-feature pipeline:

##1. Only MS2 Data is Present (empty data frame means undefinable variables)

##2. Initial expandBound() call returns (Inf, Inf) for bounds. This can happen if you have a low abundance signal
## or if your signal borders 'the void' and cannot be expanded. (range of initial bounds cannot expand > 10)
...
#args = c("/Users/ahubbard/197.13228", "/Users/ahubbard/files_for_config.txt", "/home/ahubbard/Metabolomics/outputs/outputPdfsPositive/T4_T6_T8_setariaII","/home/ahubbard/Metabolomics/outputs/vecOfIntensitiesForEachMassPositive/T4_T6_T8_setariaII")




#args = c("/Users/ahubbard/172.99361", "/Users/ahubbard/files_for_config.txt", "/home/ahubbard/Metabolomics/outputs/outputPdfsPositive/T4_T6_T8_setariaII","/home/ahubbard/Metabolomics/outputs/vecOfIntensitiesForEachMassPositive/T4_T6_T8_setariaII")

#args = c("C:/Users/Louis/OneDrive/Desktop/testSignalToNoise/360.97395", "C:/Users/Louis/OneDrive/Desktop/fileListSetaria.txt", "C:/Users/Louis/OneDrive/Desktop/testSignalToNoise/outs","C:/Users/Louis/OneDrive/Desktop/testSignalToNoise/outs")
...
expandBounds = function(referenceFirstPolish)
{
  ...
  #it's possible this is a suepr sparse signal - we want to see if we 
  if(nrow(fullTableInfo)  < 10)
  {
